...
│   ├── bioconductor_demo/      # Bioconductor模块综合示例 (ChIPseeker峰注释、DOSE疾病富集、ReactomePA通路分析、AnnotationDbi注释数据库、clusterProfiler富集框架、WGCNA共表达网络、Batchelor单细胞批次校正)
...
| bioconductor_demo | Bioconductor模块综合示例（ChIPseeker峰注释、DOSE疾病富集、ReactomePA通路分析、AnnotationDbi注释数据库、clusterProfiler富集框架、WGCNA共表达网络、Batchelor单细胞批次校正） | `moon run examples/bioconductor_demo/main.mbt` |
