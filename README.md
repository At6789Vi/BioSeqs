...
│   └── bioconductor_demo/       # Bioconductor模块综合示例 (ChIPseeker峰注释、DOSE疾病富集、ReactomePA通路分析)
├── test/
...
| bioconductor_demo | Bioconductor模块综合示例（ChIPseeker峰注释、DOSE疾病富集、ReactomePA通路分析） | `moon run examples/bioconductor_demo/main.mbt` |
